...
#include <memory>
#include "python2.7.13/dev/include/python.h"

#include "PythonApi.h"

class Python2Api : public PythonApi
{
public:
    typedef std::shared_ptr<Python2Api> Ptr;
    ...
    struct Api
    {
        ...
        _MX_DECLARE_CALL_FUNCTION_(void, _cdecl, Py_SetPythonHome)(const char*);
        ...
        _MX_DECLARE_CALL_FUNCTION_(PyObject*, _cdecl, PyFile_FromString)(char*, char*);
        PyFile_FromString File_FromString;

        //PyAPI_FUNC(FILE*) PyFile_AsFile(PyObject*);
        _MX_DECLARE_CALL_FUNCTION_(FILE*, _cdecl, PyFile_AsFile)(PyObject*);
        PyFile_AsFile File_AsFile;
